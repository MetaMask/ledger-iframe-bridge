...
export default function TestEthCommands() {
  ...
  const { bridge, sessionId, deviceStatus } = useLedgerRedux();

  const isDisabled = !bridge || deviceStatus !== DeviceStatus.CONNECTED;

  const handleSignTransaction = useCallback(async () => {
    try {
      const hdPath = LEDGER_LIVE_PATH;
      const tx =
        '02eb83aa36a718843b9aca008502540be400825208940c54fccd2e384b4bb6f2e405bf5cbc15a017aafb8080c0';
  ...
  const handleSignPersonalMessage = useCallback(async () => {
    try {
      ...
      await bridge.signPersonalMessage(
